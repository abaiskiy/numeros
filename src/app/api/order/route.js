...
{
  "intro": "3-4 предложения — что такое психоматрица Пифагора и чему посвящён этот разбор для ${name}. Упомяни число судьбы и душевное число.",
  "keyNumbers": {
    "destiny": "130-160 слов: глубокий разбор числа судьбы ${matrix.destiny} для ${name} — жизненный путь, главное предназначение, как это число проявляется в характере, выборах и судьбоносных событиях. Конкретные жизненные ситуации. Обращение на Вы.",
    "soul": "100-120 слов: число души ${matrix.soul} — глубинные желания, истинные ценности, чего ${name} ищет в глубине души и в отношениях. Обращение на Вы.",
    "karma": "100-120 слов: число кармы ${matrix.karma} — уроки этого воплощения, какие ситуации повторяются пока урок не усвоен. Обращение на Вы.",
    "potential": "80-100 слов: число потенциала ${matrix.hidden} — скрытые таланты, которые раскрываются со временем. Обращение на Вы."
  },
  "cells": [
    {
      "digit": 1,
      ...
      "content": "100-130 слов: детальный анализ характера ${name} — как волевые качества проявляются в поведении, решениях, отношениях. Конкретно и лично. Обращение на Вы."
    },
    { "digit": 2, "title": "Энергия и биополе", "value": "${matrix.energy.v}", "status": "${matrix.energy.s}", "content": "80-100 слов: энергетический потенциал, как восполняется и расходуется энергия. Обращение на Вы." },
    { "digit": 3, "title": "Интерес к жизни", "value": "${matrix.interest.v}", "status": "${matrix.interest.s}", "content": "80-100 слов: любопытство, увлечения, как ${name} находит смысл и радость. Обращение на Вы." },
    { "digit": 4, "title": "Здоровье и тело", "value": "${matrix.health.v}", "status": "${matrix.health.s}", "content": "80-100 слов: отношение к телу и здоровью, уязвимые места, рекомендации. Обращение на Вы." },
    { "digit": 5, "title": "Логика и интуиция", "value": "${matrix.logic.v}", "status": "${matrix.logic.s}", "content": "80-100 слов: аналитика vs интуиция, как принимаются решения. Обращение на Вы." },
    { "digit": 6, "title": "Труд и материальный мир", "value": "${matrix.labor.v}", "status": "${matrix.labor.s}", "content": "80-100 слов: отношение к труду и деньгам, что помогает и мешает в создании достатка. Обращение на Вы." },
    { "digit": 7, "title": "Удача и везение", "value": "${matrix.luck.v}", "status": "${matrix.luck.s}", "content": "80-100 слов: как проявляется удача, в каких сферах везёт чаще. Обращение на Вы." },
    { "digit": 8, "title": "Чувство долга и ответственность", "value": "${matrix.duty.v}", "status": "${matrix.duty.s}", "content": "80-100 слов: отношение к обязательствам, как это влияет на отношения и карьеру. Обращение на Вы." },
    { "digit": 9, "title": "Память и интеллект", "value": "${matrix.memory.v}", "status": "${matrix.memory.s}", "content": "80-100 слов: интеллектуальный потенциал, память, способность к обучению. Обращение на Вы." }
  ],
  "combinations": [
    ...
    ${foundCombinations.length === 0 ? '' : foundCombinations.map(c => `{
      "title": "${c.label}",
      "digits": "${c.digits}",
      "content": "120-150 слов: персональный разбор этой комбинации для ${name} — как она проявляется в реальной жизни, в чём сила и ловушка этого сочетания, конкретные практические советы. ${c.bookDesc ? 'Книжный контекст: ' + c.bookDesc.replace(/"/g, "'") : 'Опирайся на нумерологические знания по данной комбинации.'}. Обращение на Вы."
    }`).join(',\n    ')}
  ],
  "money": {
    "score": <число от 1 до 10>,
    "title": "Денежный потенциал",
    "content": "140-170 слов: подробный анализ финансового потенциала ${name} — природные таланты в зарабатывании, в каких сферах деньги приходят легче, какой стиль работы наиболее прибылен для этого числа. Конкретно и детально. Обращение на Вы.",
    "blocks": "70-90 слов: конкретные денежные блоки ${name} — убеждения и паттерны которые мешают зарабатывать больше, откуда берутся. Обращение на Вы.",
    "strategy": "60-80 слов: персональная стратегия роста дохода под число судьбы ${matrix.destiny} — 3 практических шага для этого типа личности. Обращение на Вы."
  },
  "relationships": {
    "title": "Код отношений",
    "content": "130-160 слов: анализ ${name} в отношениях — как любит, чего ждёт от партнёра, типичные паттерны, идеальный партнёр, типичные ошибки в любви. Обращение на Вы."
  },
  "forecast": {
    "year": ${currentYear},
    "personalYear": ${personalYear},
    "title": "Прогноз на ${currentYear} год",
    "content": "120-150 слов: что несёт личный год ${personalYear} для ${name} — главные темы, что открывается и закрывается, акценты в карьере и личной жизни. Обращение на Вы."
  },
  "personalMonth": {
  ...
  "career": {
    ...
    "content": "140-170 слов: детальный карьерный разбор ${name} — в каких сферах реализуется максимально, что даётся природно, идеальный формат работы, стиль управления, отношения с коллегами. Конкретные рекомендации. Обращение на Вы.",
    "anticareer": "50-60 слов: в каких сферах или ролях ${name} будет не на месте — и почему с точки зрения чисел. Обращение на Вы."
  },
  "shadow": {
    "title": "Теневая сторона",
    "content": "120-150 слов: честный разбор теневой стороны ${name} — деструктивные паттерны, страхи, самосаботаж, как тень проявляется в конкретных ситуациях. Без осуждения — это обратная сторона сильных качеств. Обращение на Вы.",
    "fears": ["конкретный страх или паттерн 1 (6-10 слов)", "страх/паттерн 2", "страх/паттерн 3", "страх/паттерн 4"],
    "growth": "50-60 слов: конкретные инструменты работы с тенью для этого типа личности. Обращение на Вы."
  },
  "strengths": [
    "конкретная сильная сторона 1 с пояснением как она проявляется (18-22 слова)",
    "сильная сторона 2 (18-22 слова)",
    "сильная сторона 3 (18-22 слова)",
    "сильная сторона 4 (18-22 слова)",
    "сильная сторона 5 (18-22 слова)"
  ],
  "weaknesses": [
    "зона роста 1 — что конкретно развивать и как (18-22 слова)",
    "зона роста 2 (18-22 слова)",
    "зона роста 3 (18-22 слова)"
  ],
  "lines": {
    "selfEsteem":   "60-80 слов: линия Самооценки (1-2-3) со значением ${matrix.selfEsteem} — самовосприятие, самооценка, самовыражение ${name}. Обращение на Вы.",
    "household":    "60-80 слов: линия Быта (4-5-6) со значением ${matrix.household} — отношение к дому, комфорту, бытовым задачам. Обращение на Вы.",
    "talent":       "60-80 слов: линия Таланта (7-8-9) со значением ${matrix.talent} — природные дарования и творческий потенциал. Обращение на Вы.",
    "goal":         "60-80 слов: линия Целеустремлённости (1-4-7) со значением ${matrix.goal} — воля к цели и достижение результатов. Обращение на Вы.",
    "family":       "60-80 слов: линия Семьи (2-5-8) со значением ${matrix.family} — роль в семье, отношение к близким. Обращение на Вы.",
    "stability":    "60-80 слов: линия Стабильности (3-6-9) со значением ${matrix.stability} — умение создавать устойчивость. Обращение на Вы.",
    "spirituality": "60-80 слов: линия Духовности (1-5-9) со значением ${matrix.spirituality} — связь с высшим, интуиция, поиск смысла. Обращение на Вы.",
    "temperament":  "60-80 слов: линия Темперамента (3-5-7) со значением ${matrix.temperament} — тип темперамента, эмоциональность. Обращение на Вы."
  },
  "karmicSummary": "60-80 слов: что означают кармические уроки для ${name}, как с ними работать. Обращение на Вы.",
  ...
  "archetype": {
    ...
    "description": "100-120 слов: суть архетипа применительно к ${name} — как он проявляется в жизни, решениях, отношениях, в чём миссия. Обращение на Вы.",
  ...
  "conclusion": "180-220 слов: глубокое заключение — главные инсайты разбора, уникальность ${name} как личности, ключевые рекомендации, вдохновляющее напутствие. Обращение на Вы."
}

ВАЖНО: Пиши на русском. Обращайся на Вы. ${genderTone} Используй имя ${name} и конкретные числа из матрицы в тексте. Будь честным — указывай и сильные стороны, и слабые, и страхи. Это делает разбор живым и доверительным.`;
