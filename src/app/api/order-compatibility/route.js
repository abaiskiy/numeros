...
{
  "intro": "3-4 предложения — общее впечатление о союзе, упомяни конкретные числа судьбы и души обоих. Обращение к паре на Вы.",
  "overallLevel": "${score >= 85 ? 'Исключительная' : score >= 70 ? 'Высокая' : score >= 55 ? 'Хорошая' : 'Требует работы'}",
  "overallDesc": "100-130 слов — что означает балл ${score} именно для ${name1 || 'первого'} и ${name2 || 'второго'}: какова динамика союза, в чём главная сила и главный вызов этой пары, какой потенциал заложен в этих числах. Конкретно. Обращение на Вы.",
  "spheres": [
    { "title": "Романтика и страсть",  "icon": "Ро", "color": "rose",   "score": <0-100>, "content": "100-120 слов — опирайся на числа энергии(2) и темперамента обоих. Как разворачивается романтика, страсть и влечение именно в этой паре, что усиливает и что гасит огонь. Конкретно." },
    { "title": "Семья и быт",          "icon": "Сб", "color": "amber",  "score": <0-100>, "content": "100-120 слов — опирайся на линию Быта и поле Долга(8). Как пара справляется с совместным бытом, кто в какой роли, где возникают трения и как их сгладить. Конкретно." },
    { "title": "Интеллект и общение",  "icon": "Ин", "color": "blue",   "score": <0-100>, "content": "100-120 слов — опирайся на Логику(5) и Память(9). Насколько совпадают стили мышления, как строится общение, о чём легко говорить и где возникают недопонимания. Конкретно." },
    { "title": "Финансы и цели",       "icon": "Фн", "color": "green",  "score": <0-100>, "content": "100-120 слов — опирайся на Труд(6) и Целеустремлённость. Как пара управляет деньгами и совместными целями, где совпадают амбиции, а где расходятся приоритеты. Конкретно." },
    { "title": "Доверие и поддержка",  "icon": "Дв", "color": "purple", "score": <0-100>, "content": "100-120 слов — опирайся на Долг(8) и Духовность. Насколько пара умеет опираться друг на друга в трудных ситуациях, как строится доверие и поддержка. Конкретно." },
    { "title": "Духовный рост",        "icon": "Дх", "color": "teal",   "score": <0-100>, "content": "100-120 слов — опирайся на Духовность и линию Таланта. Как пара развивается вместе, совпадают ли ценности, помогают ли друг другу расти. Конкретно." }
  ],
  "keyNumbers": {
    "destiny": { "v1": ${m1.destiny}, "v2": ${m2.destiny}, "match": ${destinyMatch}, "content": "80-100 слов — как взаимодействуют именно эти числа судьбы в паре, какая динамика и чему они могут научить друг друга" },
    "soul":    { "v1": ${m1.soul},    "v2": ${m2.soul},    "match": ${soulMatch},    "content": "80-100 слов — внутренняя эмоциональная гармония, совпадают ли глубинные ценности и потребности" },
    "karma":   { "v1": ${m1.karma},   "v2": ${m2.karma},   "match": ${karmaMatch},   "content": "70-90 слов — общие кармические уроки и задачи в этом союзе, что проходят вместе" }
  },
  "loveLanguages": {
    "person1": {
      "primary": "язык любви ${name1 || 'первого'} — одно из: Слова признания / Прикосновения / Время / Подарки / Помощь",
      "description": "70-85 слов — как ${name1 || 'первый'} выражает и принимает любовь, что для него/неё важно в отношениях, опирайся на число души ${m1.soul} и энергию(2)"
    },
    "person2": {
      "primary": "язык любви ${name2 || 'второго'} — одно из: Слова признания / Прикосновения / Время / Подарки / Помощь",
      "description": "70-85 слов — как ${name2 || 'второй'} выражает и принимает любовь, опирайся на число души ${m2.soul} и энергию(2)"
    },
    "compatibility": "60-75 слов — насколько совместимы их языки любви, где возникает непонимание, конкретный совет как создать гармонию"
  },
  "strengths": [
    "Сила 1: что конкретно усиливают друг в друге, ссылаясь на числа (25-35 слов)",
    "Сила 2 (25-35 слов)",
    "Сила 3 (25-35 слов)",
    "Сила 4 (25-35 слов)",
    "Сила 5 (25-35 слов)"
  ...
  "tensions": [
    "Напряжение 1 — в чём проявляется и конкретный совет как проработать (25-35 слов)",
    "Напряжение 2 + совет (25-35 слов)",
    "Напряжение 3 + совет (25-35 слов)"
  ],
  "greenFlags": [
    "Зелёный флаг 1 — конкретное преимущество этого союза (15-20 слов)",
    "Зелёный флаг 2 (15-20 слов)",
    "Зелёный флаг 3 (15-20 слов)",
    "Зелёный флаг 4 (15-20 слов)"
  ],
  "dangerSignals": [
    "Сигнал 1 — что конкретно может разрушить союз и как предотвратить (15-20 слов)",
    "Сигнал 2 (15-20 слов)",
    "Сигнал 3 (15-20 слов)"
  ],
  "bestYears": {
    "content": "90-110 слов — когда пик совместных возможностей с учётом личных лет ${py1[0]?.year ?? curYear}–${(py1[py1.length-1]?.year) ?? curYear+2}. Конкретные годы, что делать в каждый период, какие решения принимать."
  },
  "personalYearNote": "80-100 слов: ${name1} в ЛГ-${py1[0]?.personalYear ?? '?'}, ${name2} в ЛГ-${py2[0]?.personalYear ?? '?'} — что это значит для пары в ${curYear} году, как синхронизировать свои энергии, конкретные рекомендации",
  "personalMonths": {
    "person1": { "number": ${pm1.number}, "label": "${pm1.label}", "content": "50-60 слов: что сейчас переживает ${name1} в личном месяце ${pm1.number} и как это влияет на динамику пары прямо сейчас" },
    "person2": { "number": ${pm2.number}, "label": "${pm2.label}", "content": "50-60 слов: что сейчас переживает ${name2} в личном месяце ${pm2.number} и как это влияет на пару" },
    "together": "50-60 слов: как совпадение или расхождение личных месяцев влияет на их взаимодействие прямо сейчас, что важно учесть"
  },
  "conflictZones": {
    "content": "110-130 слов: честный анализ — в каких ситуациях эта пара чаще всего конфликтует, какие триггеры срабатывают, почему это происходит с точки зрения их чисел. Без осуждения, конкретно.",
    "triggers": ["триггер 1 (10-14 слов)", "триггер 2 (10-14 слов)", "триггер 3 (10-14 слов)"],
    "resolution": "60-75 слов: 3 конкретных инструмента для разрядки конфликтов именно для этой пары"
  },
  "jointProject": {
    "suitable": <true или false — подходит ли эта пара для совместного бизнеса/дела>,
    "content": "90-110 слов: честный анализ совместимости в деловой сфере — где сильны вместе, где могут мешать друг другу, на каких ролях каждый лучше. Опирайся на числа судьбы и линии матрицы.",
    "roles": { "person1": "роль ${name1} в совместном проекте (6-10 слов)", "person2": "роль ${name2} в совместном проекте (6-10 слов)" },
    "bestSpheres": ["сфера 1 для совместного дела (3-5 слов)", "сфера 2 (3-5 слов)", "сфера 3 (3-5 слов)"]
  },
  "recommendations": [
    "Рекомендация 1 — конкретный практический совет для пары (30-40 слов)",
    "Рекомендация 2 (30-40 слов)",
    "Рекомендация 3 (30-40 слов)",
    "Рекомендация 4 (30-40 слов)",
    "Рекомендация 5 (30-40 слов)"
  ],
  "conclusion": "200-240 слов — глубокий итоговый вывод о союзе ${name1 || 'первого'} и ${name2 || 'второго'}. Честный, вдохновляющий, конкретный. Упомяни числа. Что этот союз может дать обоим, к чему стремиться, как развиваться вместе. Обращение на Вы."
}

ВАЖНО: Пиши ТОЛЬКО на русском. Обращайся к паре на Вы. Используй имена ${name1} и ${name2} и конкретные числа из матриц в тексте. Никаких placeholder-ов — только реальный персонализированный анализ.`;
