...
const FAMOUS_BY_DESTINY = {
  19: [{ name: 'Исаак Ньютон',        field: 'Физика'          }, { name: 'Джордж Вашингтон',  field: 'Политика'        }, { name: 'Уолт Дисней',          field: 'Кино / Анимация' }],
  20: [{ name: 'Диего Марадона',       field: 'Спорт'           }, { name: 'Пеле',               field: 'Спорт'           }, { name: 'Клод Моне',            field: 'Живопись'        }],
  21: [{ name: 'Виктор Гюго',          field: 'Литература'      }, { name: 'Сальвадор Дали',     field: 'Искусство'       }, { name: 'Михаил Лермонтов',     field: 'Литература'      }],
  22: [{ name: 'Леонардо да Винчи',    field: 'Искусство/Наука' }, { name: 'Фрэнк Синатра',      field: 'Музыка'          }, { name: 'Клинт Иствуд',         field: 'Кино'            }],
  23: [{ name: 'Авраам Линкольн',      field: 'Политика'        }, { name: 'Чарльз Дарвин',      field: 'Наука'           }, { name: 'Пьер-Огюст Ренуар',    field: 'Живопись'        }],
  24: [{ name: 'Джон Леннон',          field: 'Музыка'          }, { name: 'Томас Эдисон',       field: 'Изобретения'     }, { name: 'Дж.Р.Р. Толкин',       field: 'Литература'      }],
  25: [{ name: 'Стивен Хокинг',        field: 'Физика'          }, { name: 'Мэрилин Монро',      field: 'Кино'            }, { name: 'Леонардо ДиКаприо',    field: 'Кино'            }],
  26: [{ name: 'Пабло Пикассо',        field: 'Искусство'       }, { name: 'Нил Армстронг',      field: 'Космос'          }, { name: 'Микеланджело',         field: 'Искусство'       }],
  27: [{ name: 'Махатма Ганди',        field: 'Философия'       }, { name: 'Мать Тереза',        field: 'Гуманизм'        }, { name: 'Элвис Пресли',         field: 'Музыка'          }],
  28: [{ name: 'Стив Джобс',           field: 'Технологии'      }, { name: 'Никола Тесла',       field: 'Физика'          }, { name: 'Эминем',               field: 'Музыка'          }],
  29: [{ name: 'Барак Обама',          field: 'Политика'        }, { name: 'Моцарт',             field: 'Музыка'          }, { name: 'Майкл Джордан',        field: 'Спорт'           }],
  30: [{ name: 'Дэвид Боуи',           field: 'Музыка'          }, { name: 'Криштиану Роналду',  field: 'Спорт'           }, { name: 'Риана',                field: 'Музыка'          }],
  31: [{ name: 'Билл Гейтс',           field: 'Технологии'      }, { name: 'Опра Уинфри',        field: 'Медиа'           }, { name: 'Арнольд Шварценеггер', field: 'Кино/Политика'   }],
  32: [{ name: 'Мик Джаггер',          field: 'Музыка'          }, { name: 'Анджелина Джоли',    field: 'Кино'            }, { name: 'Бейонсе',              field: 'Музыка'          }],
  33: [{ name: 'Альберт Эйнштейн',     field: 'Наука'           }, { name: 'Мэрил Стрип',        field: 'Кино'            }, { name: 'Сильвестр Сталлоне',   field: 'Кино'            }],
  34: [{ name: 'Джон Кеннеди',         field: 'Политика'        }, { name: 'Тейлор Свифт',       field: 'Музыка'          }, { name: 'Джонни Депп',          field: 'Кино'            }],
  35: [{ name: 'Роджер Федерер',        field: 'Спорт'           }, { name: 'Усэйн Болт',         field: 'Спорт'           }, { name: 'Нельсон Мандела',      field: 'Политика'        }],
  36: [{ name: 'Принс',                field: 'Музыка'          }, { name: 'Уитни Хьюстон',      field: 'Музыка'          }, { name: 'Серена Уильямс',       field: 'Спорт'           }],
  37: [{ name: 'Наполеон Бонапарт',    field: 'История'         }, { name: 'Лионель Месси',       field: 'Спорт'           }, { name: 'Том Хэнкс',            field: 'Кино'            }],
  38: [{ name: 'Билл Клинтон',         field: 'Политика'        }, { name: 'Мадонна',             field: 'Музыка'          }, { name: 'Канье Уэст',           field: 'Музыка'          }],
  39: [{ name: 'Альфред Хичкок',       field: 'Кино'            }, { name: 'Мария Шарапова',      field: 'Спорт'           }],
  40: [{ name: 'Уилл Смит',            field: 'Кино'            }, { name: 'Адам Сэндлер',        field: 'Кино'            }],
  41: [{ name: 'Уильям Фолкнер',       field: 'Литература'      }, { name: 'Хорхе Луис Борхес',   field: 'Литература'      }],
  42: [{ name: 'Майкл Джексон',        field: 'Музыка'          }, { name: 'Т.С. Элиот',          field: 'Литература'      }],
};

export function getFamousByDestiny(destiny) {
  return FAMOUS_BY_DESTINY[Math.abs(destiny)] ?? [];
}
