...
const s = StyleSheet.create({
  ...
  coverLogoDot: { width: 34, height: 34, borderRadius: 17, borderWidth: 1, borderColor: C.gold, backgroundColor: C.goldFaint, alignItems: 'center', paddingTop: 9 },
  ...
  coverTocNum: { width: 18, height: 18, borderRadius: 9, backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, alignItems: 'center', paddingTop: 5 },
  ...
  karmicNumCircle: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#1E1030', borderWidth: 1, borderColor: '#3A2055', alignItems: 'center', paddingTop: 7 },
  ...
  pinnacleNumCircle: { width: 36, height: 36, borderRadius: 18, backgroundColor: C.goldFaint, borderWidth: 1.5, borderColor: C.goldBorder, alignItems: 'center', paddingTop: 10, flexShrink: 0 },
  ...
  pyNumCircle: { width: 24, height: 24, borderRadius: 12, backgroundColor: '#1A1B26', borderWidth: 1, borderColor: C.border, alignItems: 'center', paddingTop: 6, marginRight: 10, flexShrink: 0 },
  ...
  famousCircle: { width: 40, height: 40, borderRadius: 20, backgroundColor: C.goldFaint, borderWidth: 1.5, borderColor: C.gold, alignItems: 'center', paddingTop: 12, marginBottom: 8 },
