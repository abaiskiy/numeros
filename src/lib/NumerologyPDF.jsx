...
const s = StyleSheet.create({
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, borderRadius: 20, paddingHorizontal: 12, paddingTop: 6, paddingBottom: 2, marginBottom: 18 },
  ...
  statusBadge: { borderRadius: 8, paddingHorizontal: 5, paddingTop: 3, paddingBottom: 1, marginTop: 2 },
  ...
  cellBadge: { borderRadius: 10, paddingHorizontal: 8, paddingTop: 4, paddingBottom: 1.5 },
  ...
  combChip: { backgroundColor: '#1E1530', borderWidth: 1, borderColor: '#3A2A50', borderRadius: 6, paddingHorizontal: 8, paddingTop: 5, paddingBottom: 1.5 },
  ...
  pyCurrentBadge: { backgroundColor: C.gold, borderRadius: 6, paddingHorizontal: 6, paddingTop: 3.5, paddingBottom: 0.5, marginLeft: 6 },
