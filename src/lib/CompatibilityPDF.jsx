...
const s = StyleSheet.create({
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, borderRadius: 20, paddingHorizontal: 12, height: 18, justifyContent: 'center', paddingBottom: 1, marginBottom: 32 },
