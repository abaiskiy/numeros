...
const s = StyleSheet.create({
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, borderRadius: 20, paddingHorizontal: 12, paddingTop: 6, paddingBottom: 2, marginBottom: 32 },
  ...
  keyNumMatchBadge: { backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, borderRadius: 8, paddingHorizontal: 6, paddingTop: 3, paddingBottom: 1 },
  ...
  lovePrimaryBadge: { borderRadius: 8, paddingHorizontal: 8, paddingTop: 5, paddingBottom: 1.5, alignSelf: 'flex-start', marginBottom: 6 },
