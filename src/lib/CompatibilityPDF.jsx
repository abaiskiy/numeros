...
const s = StyleSheet.create({
  ...
  // Cover
  coverTop: { padding: 28, paddingBottom: 0 },
  coverLogoRow: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 28 },
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, borderRadius: 20, paddingHorizontal: 12, height: 18, justifyContent: 'center', paddingBottom: 1, marginBottom: 16 },
  ...
  coverTitle: { fontSize: 12, color: C.grayLight, marginBottom: 24 },
  coverScoreBlock: { alignItems: 'center', paddingVertical: 18, borderTopWidth: 1, borderTopColor: C.border },
  coverScoreCircle: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: C.rose, alignItems: 'center', justifyContent: 'center', paddingBottom: 4, marginBottom: 10, backgroundColor: C.roseFaint },
  ...
  coverToc: { padding: 20, paddingTop: 0, flexDirection: 'row', flexWrap: 'wrap', gap: 5 },
  ...
  coverTocNum: { width: 15, height: 15, borderRadius: 8, backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, alignItems: 'center', justifyContent: 'center', paddingBottom: 1 },
  ...
  coverBottom: { paddingHorizontal: 28, paddingBottom: 16, flexDirection: 'row', justifyContent: 'space-between' },
  ...
  scoreBigCircle: { width: 100, height: 100, borderRadius: 50, borderWidth: 3, borderColor: C.rose, alignItems: 'center', justifyContent: 'center', paddingBottom: 4, backgroundColor: C.roseFaint, marginBottom: 8 },
  ...
  sphereIconBox: { width: 28, height: 28, borderRadius: 7, alignItems: 'center', justifyContent: 'center', paddingBottom: 2 },
  ...
  keyNumMatchBadge: { backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, borderRadius: 8, paddingHorizontal: 6, height: 14, justifyContent: 'center', paddingBottom: 1 },
  ...
  lovePrimaryBadge: { borderRadius: 8, paddingHorizontal: 8, height: 17, justifyContent: 'center', paddingBottom: 1, alignSelf: 'flex-start', marginBottom: 6 },
  ...
  pyCompCircle: { width: 22, height: 22, borderRadius: 11, alignItems: 'center', justifyContent: 'center', paddingBottom: 2, borderWidth: 1 },
  ...
  recNum: { width: 18, height: 18, borderRadius: 9, backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, alignItems: 'center', justifyContent: 'center', paddingBottom: 1, flexShrink: 0 },
  ...
  pmPersonNum: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#0E1A2E', borderWidth: 1.5, borderColor: C.blue, alignItems: 'center', justifyContent: 'center', paddingBottom: 2 },
