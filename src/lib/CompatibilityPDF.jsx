...
const s = StyleSheet.create({
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, borderRadius: 20, paddingHorizontal: 12, minHeight: 16, justifyContent: 'center', marginBottom: 32 },
  coverBadgeText: { fontSize: 7.5, color: C.rose, fontFamily: 'Roboto', fontWeight: 'bold', letterSpacing: 2, textAlign: 'center' },
  ...
  keyNumMatchBadge: { backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, borderRadius: 8, paddingHorizontal: 6, minHeight: 12, justifyContent: 'center' },
  keyNumMatchText: { fontSize: 6.5, color: C.gold, fontFamily: 'Roboto', fontWeight: 'bold', textAlign: 'center' },
  ...
  lovePrimaryBadge: { borderRadius: 8, paddingHorizontal: 8, minHeight: 15, justifyContent: 'center', alignSelf: 'flex-start', marginBottom: 6 },
  lovePrimaryText: { fontSize: 8, fontFamily: 'Roboto', fontWeight: 'bold', textAlign: 'center' },
