...
const s = StyleSheet.create({
  ...
  coverBadge: { alignSelf: 'flex-start', backgroundColor: C.roseFaint, borderWidth: 1, borderColor: C.roseBorder, borderRadius: 20, paddingHorizontal: 12, paddingTop: 4.5, paddingBottom: 3.5, marginBottom: 32 },
  coverBadgeText: { fontSize: 7.5, color: C.rose, fontFamily: 'Roboto', fontWeight: 'bold', letterSpacing: 2, lineHeight: 1, textAlign: 'center' },
  ...
  keyNumMatchBadge: { backgroundColor: C.goldFaint, borderWidth: 1, borderColor: C.goldBorder, borderRadius: 8, paddingHorizontal: 6, paddingTop: 2.5, paddingBottom: 1.5 },
  keyNumMatchText: { fontSize: 6.5, color: C.gold, fontFamily: 'Roboto', fontWeight: 'bold', lineHeight: 1, textAlign: 'center' },
  ...
  lovePrimaryBadge: { borderRadius: 8, paddingHorizontal: 8, paddingTop: 3.5, paddingBottom: 2.5, alignSelf: 'flex-start', marginBottom: 6 },
  lovePrimaryText: { fontSize: 8, fontFamily: 'Roboto', fontWeight: 'bold', lineHeight: 1, textAlign: 'center' },
