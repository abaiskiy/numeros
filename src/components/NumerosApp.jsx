...
const FAMOUS_BY_DIGIT = {
  ...
  3: {
    ...
    people: [
      ...
      { name: 'Селин Дион',        field: 'Музыка', birth: '30.03.1968', fact: 'Продала 200+ млн альбомов' },
    ],
  },
  4: {
    ...
    people: [
      ...
      { name: 'Шварценеггер', field: 'Кино / Политика', birth: '30.07.1947', fact: 'Губернатор, актёр, чемпион' },
  ...
  7: {
    ...
    people: [
      ...
      { name: 'Мерилин Монро',     field: 'Кино',   birth: '01.06.1926', fact: 'Икона красоты и культуры 50-х' },
