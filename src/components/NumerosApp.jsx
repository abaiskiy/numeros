...
// Знаменитости подобраны по точному числу судьбы (A = сумма всех цифр даты рождения),
// каждая дата рождения верифицирована вручную.
const FAMOUS_BY_DESTINY = {
  19: {
    trait: 'Лидерство, новаторство, независимость',
    people: [
      { name: 'Исаак Ньютон',      field: 'Физика',          birth: '04.01.1643', fact: 'Открыл законы гравитации и механики' },
      { name: 'Джордж Вашингтон',  field: 'Политика',        birth: '22.02.1732', fact: 'Первый президент США' },
      { name: 'Уолт Дисней',       field: 'Кино / Анимация', birth: '05.12.1901', fact: 'Создатель самой известной анимационной вселенной' },
    ],
  },
  20: {
    trait: 'Дипломатия, интуиция, сотрудничество',
    people: [
      { name: 'Диего Марадона', field: 'Спорт',    birth: '30.10.1960', fact: 'Легенда футбола, бог на поле' },
      { name: 'Пеле',           field: 'Спорт',    birth: '23.10.1940', fact: 'Трёхкратный чемпион мира, король футбола' },
      { name: 'Клод Моне',      field: 'Живопись', birth: '14.11.1840', fact: 'Основатель импрессионизма' },
    ],
  },
  21: {
    trait: 'Творчество, общение, вдохновение',
    people: [
      { name: 'Виктор Гюго',          field: 'Литература', birth: '26.02.1802', fact: 'Автор «Отверженных» и «Собора Парижской Богоматери»' },
      { name: 'Сальвадор Дали',        field: 'Искусство',  birth: '11.05.1904', fact: 'Мастер сюрреализма, автор культовых образов' },
      { name: 'Михаил Лермонтов',      field: 'Литература', birth: '15.10.1814', fact: 'Автор «Героя нашего времени»' },
    ],
  },
  22: {
    trait: 'Системность, труд, надёжность',
    people: [
      { name: 'Леонардо да Винчи', field: 'Искусство / Наука', birth: '15.04.1452', fact: 'Гений Возрождения — художник, учёный, изобретатель' },
      { name: 'Фрэнк Синатра',     field: 'Музыка',            birth: '12.12.1915', fact: 'Голос Америки, икона эпохи' },
      { name: 'Клинт Иствуд',      field: 'Кино',              birth: '31.05.1930', fact: 'Легенда Голливуда, режиссёр и актёр' },
    ],
  },
  23: {
    trait: 'Свобода, перемены, харизма',
    people: [
      { name: 'Авраам Линкольн',     field: 'Политика', birth: '12.02.1809', fact: 'Отменил рабство и спас единство США' },
      { name: 'Чарльз Дарвин',       field: 'Наука',    birth: '12.02.1809', fact: 'Создал теорию эволюции' },
      { name: 'Пьер-Огюст Ренуар',   field: 'Живопись', birth: '25.02.1841', fact: 'Один из основоположников импрессионизма' },
    ],
  },
  24: {
    trait: 'Ответственность, гармония, искусство',
    people: [
      { name: 'Джон Леннон',   field: 'Музыка',      birth: '09.10.1940', fact: 'Один из основателей The Beatles' },
      { name: 'Томас Эдисон',  field: 'Изобретения', birth: '11.02.1847', fact: '1 000+ патентов, создал лампочку и фонограф' },
      { name: 'Дж.Р.Р. Толкин', field: 'Литература', birth: '03.01.1892', fact: 'Создатель мира Средиземья' },
    ],
  },
  25: {
    trait: 'Аналитика, мудрость, духовный поиск',
    people: [
      { name: 'Стивен Хокинг',     field: 'Физика', birth: '08.01.1942', fact: 'Раскрыл тайны чёрных дыр вопреки параличу' },
      { name: 'Мэрилин Монро',     field: 'Кино',   birth: '01.06.1926', fact: 'Икона красоты и культуры 50-х' },
      { name: 'Леонардо ДиКаприо', field: 'Кино',   birth: '11.11.1974', fact: 'Оскар и борьба за климат' },
    ],
  },
  26: {
    ...
    people: [
      ...
      { name: 'Нил Армстронг', field: 'Космос',    birth: '05.08.1930', fact: 'Первый человек на Луне' },
      { name: 'Микеланджело',  field: 'Искусство', birth: '06.03.1475', fact: 'Автор «Сикстинской капеллы» и «Давида»' },
    ],
  },
  27: {
  ...
  28: {
    trait: 'Лидерство, новаторство, независимость',
    people: [
      { name: 'Стив Джобс',   field: 'Технологии', birth: '24.02.1955', fact: 'Изменил несколько индустрий' },
      { name: 'Никола Тесла', field: 'Физика',      birth: '10.07.1856', fact: 'Изобретатель переменного тока' },
      { name: 'Эминем',       field: 'Музыка',      birth: '17.10.1972', fact: 'Самый продаваемый рэпер в истории' },
    ],
  },
  29: {
    trait: 'Дипломатия, интуиция, сотрудничество',
    people: [
      ...
      { name: 'Моцарт',         field: 'Музыка',   birth: '27.01.1756', fact: 'Гений классической музыки' },
      { name: 'Майкл Джордан',  field: 'Спорт',    birth: '17.02.1963', fact: 'Лучший баскетболист всех времён' },
    ],
  },
  30: {
    trait: 'Творчество, общение, вдохновение',
    people: [
      ...
      { name: 'Криштиану Роналду', field: 'Спорт',  birth: '05.02.1985', fact: 'Один из лучших футболистов в истории' },
      { name: 'Риана',             field: 'Музыка', birth: '20.02.1988', fact: '250+ млн проданных песен' },
    ],
  },
  31: {
    trait: 'Системность, труд, надёжность',
    people: [
      ...
      { name: 'Опра Уинфри',           field: 'Медиа',         birth: '29.01.1954', fact: 'Самая влиятельная женщина ТВ' },
  ...
  32: {
    ...
    people: [
      ...
      { name: 'Анджелина Джоли', field: 'Кино',   birth: '04.06.1975', fact: 'Оскар, посол ООН, икона поколения' },
      { name: 'Бейонсе',         field: 'Музыка', birth: '04.09.1981', fact: '32 премии Grammy, мировая суперзвезда' },
    ],
  },
  33: {
    trait: 'Ответственность, гармония, искусство',
    people: [
      ...
      { name: 'Мэрил Стрип',        field: 'Кино',  birth: '22.06.1949', fact: 'Самая номинированная актриса в истории Оскара' },
      { name: 'Сильвестр Сталлоне', field: 'Кино',  birth: '06.07.1946', fact: 'Создатель «Рокки» и «Рэмбо»' },
    ],
  },
  34: {
    trait: 'Аналитика, мудрость, духовный поиск',
    people: [
      { name: 'Джон Кеннеди',  field: 'Политика', birth: '29.05.1917', fact: '35-й президент США' },
      { name: 'Тейлор Свифт',  field: 'Музыка',   birth: '13.12.1989', fact: 'Самая продаваемая певица поколения' },
      { name: 'Джонни Депп',   field: 'Кино',     birth: '09.06.1963', fact: 'Один из самых узнаваемых актёров мира' },
    ],
  },
  35: {
    trait: 'Власть, амбиции, материальный успех',
    people: [
      { name: 'Роджер Федерер', field: 'Спорт',    birth: '08.08.1981', fact: '20 титулов Большого шлема' },
      { name: 'Усэйн Болт',     field: 'Спорт',    birth: '21.08.1986', fact: 'Самый быстрый человек в истории' },
      { name: 'Нельсон Мандела', field: 'Политика', birth: '18.07.1918', fact: 'Победил апартеид и стал символом свободы' },
    ],
  },
  36: {
    trait: 'Гуманизм, мудрость, духовная сила',
    people: [
      { name: 'Принс',             field: 'Музыка', birth: '07.06.1958', fact: 'Гений поп-, рок- и R&B-музыки' },
      { name: 'Уитни Хьюстон',     field: 'Музыка', birth: '09.08.1963', fact: 'Один из величайших вокалистов всех времён' },
      { name: 'Серена Уильямс',    field: 'Спорт',  birth: '26.09.1981', fact: '23 титула на турнирах Большого шлема' },
    ],
  },
  37: {
    trait: 'Лидерство, новаторство, независимость',
    people: [
      ...
      { name: 'Лионель Месси',     field: 'Спорт',   birth: '24.06.1987', fact: '8 «Золотых мячей», чемпион мира' },
      { name: 'Том Хэнкс',         field: 'Кино',    birth: '09.07.1956', fact: 'Дважды лауреат Оскара, символ Голливуда' },
    ],
  },
  38: {
    trait: 'Дипломатия, интуиция, сотрудничество',
    people: [
      ...
      { name: 'Мадонна',       field: 'Музыка',   birth: '16.08.1958', fact: 'Самая успешная певица в истории' },
      { name: 'Канье Уэст',    field: 'Музыка',   birth: '08.06.1977', fact: '24 Grammy, провокатор и визионер музыки' },
    ],
  },
  39: {
    trait: 'Творчество, общение, вдохновение',
    people: [
      { name: 'Альфред Хичкок',    field: 'Кино',  birth: '13.08.1899', fact: 'Мастер саспенса, режиссёр «Психо» и «Птиц»' },
      { name: 'Мария Шарапова',    field: 'Спорт', birth: '19.04.1987', fact: '5 титулов Большого шлема' },
    ],
  },
  40: {
    trait: 'Системность, труд, надёжность',
    people: [
      { name: 'Уилл Смит',     field: 'Кино', birth: '25.09.1968', fact: 'Один из самых кассовых актёров мира' },
      { name: 'Адам Сэндлер',  field: 'Кино', birth: '09.09.1966', fact: 'Комедийный актёр с миллиардными кассовыми сборами' },
    ],
  },
  41: {
    trait: 'Свобода, перемены, харизма',
    people: [
      { name: 'Уильям Фолкнер',    field: 'Литература', birth: '25.09.1897', fact: 'Нобелевский лауреат, мастер «потока сознания»' },
      { name: 'Хорхе Луис Борхес', field: 'Литература', birth: '24.08.1899', fact: 'Создатель магического реализма в литературе' },
    ],
  },
  42: {
    trait: 'Ответственность, гармония, искусство',
    people: [
      ...
      { name: 'Т.С. Элиот',    field: 'Литература', birth: '26.09.1888', fact: 'Нобелевский лауреат, автор «Бесплодной земли»' },
    ],
  },
};
      ...
      {famousData && (
        <>
          ...
          <p className="text-gray-500 text-sm mb-6">
            Число судьбы <span className="text-white/60">{matrixData.destiny}</span> объединяет вас с этими людьми —&nbsp;
...
const faqs = [
  {
    ...
    a: 'В течение 2–5 минут после оплаты. Сервис автоматически генерирует разбор и отправляет его на указанный email. Если письмо не пришло — проверьте папку «Спам». В редких случаях задержка до 10 минут.',
  },
  {
    q: 'Это шаблонный текст или персональный разбор?',
    a: 'Полностью персональный. Каждый разбор создаётся индивидуально на основе вашей конкретной даты рождения. Два человека с разными датами получат абсолютно разные тексты — разные числа, разные характеристики, разные рекомендации.',
  },
  {
    q: 'Что входит в разбор?',
    a: 'PDF объёмом 10+ страниц: матрица Пифагора с анализом всех 9 секторов, ключевые числа (Судьба, Душа, Карма, Потенциал), денежный потенциал, карьера и предназначение, теневая сторона, архетип личности, личный месяц, прогноз на год, аффирмации и талисманы.',
  },
  {
  ...
  },
  {
    ...
    a: 'Да, вы можете ввести любую дату рождения — партнёра, ребёнка, коллеги или друга. Многие используют разбор как подарок или для понимания мотивации близких. Матрица описывает потенциал, а не жёсткий приговор — человек всегда может осознанно работать над собой.',
  },
  {
